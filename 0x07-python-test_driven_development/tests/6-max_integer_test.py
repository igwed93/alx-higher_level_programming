...
class TestMaxInteger(unittest.TestCase):
    """run test with python3 -m unittest -v test.6-max_integer_test"""
    ...
    def test_max_int(self):
        # Test maximum integers in a list
        self.assertAlmostEqual(max_integer([9, 4, 6]), max([9, 4, 6]))
        self.assertAlmostEqual(max_integer([7, 8, 6]), max([7, 8, 6]))
        self.assertAlmostEqual(max_integer([0, -5, -10]), max([0, -5, -10]))
